...
def deletar_flashcard(request, id):
    ...
    if flashcard.user_id != request.user.id:
        messages.add_message(request, constants.ERROR, "Não é possível deletar flashcards de outra pessoa")
        return redirect('/flashcard/novo_flashcard/')
    flashcard.delete()
...
def relatorio(request, id):
    ...
    return render(request, 'relatorio.html', {'desafio': desafio, 'dados': dados, 'categorias': name_categoria, 'dados_radar': dados_radar})
